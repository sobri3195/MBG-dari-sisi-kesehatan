  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Insiden Kesehatan</h1>
          <p className="text-gray-500 mt-1">Riwayat insiden dan penanganan</p>
        </div>
      ...
      <div className="card">
        ...
        <div className="space-y-4">
              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <div className="flex items-center space-x-3 mb-2">
                    ...
                    <span className="badge badge-blue">{incident.incident_type.replace('_', ' ')}</span>
                  </div>
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                    <div>
                      <p className="text-gray-600">Waktu</p>
                      <p className="font-medium">{formatDateTime(incident.incident_time)}</p>
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <p className="font-medium">{incident.outcome.replace('_', ' ')}</p>
                    </div>
                  </div>
          ...
          {incidents.length === 0 && (
            <div className="text-center py-12 text-gray-500">Tidak ada data insiden</div>
          )}
        </div>
      </div>
    </div>
